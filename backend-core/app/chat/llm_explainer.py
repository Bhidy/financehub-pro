    ...
    async def generate_narrative(
        ...
        if is_deep_dive:
            ...
            system_prompt = (
                 ...
                 "CFA LEVEL III QUALITY ENFORCEMENT – MANDATORY:\n"
                 "1. **UNITS & SCALE**: explicitly state currency/scale (e.g. 'EGP Millions') for ALL figures. If unclear, state limitation.\n"
                 "2. **MARGINS VS PROFITS**: NEVER call absolute profits 'margins'. Margins are %. Absolute = 'Operating Profit'.\n"
                 "3. **SECTOR LOGIC**: No generic text. Use sector specific metrics (Banks: Loans/Deposits, RE: Sales/Deliveries).\n"
                 "4. **BENCHMARKING**: Do not say 'strong/weak' without data backing. Use 'relative to peers' or 'screens as'.\n"
                 "5. **UNSUPPORTED INFERENCE BLOCKER**: Do not infer refinancing risk/efficiency unless ratios exist. Say 'Data not available' if needed.\n"
                 "6. **CASH FLOW PRIORITY**: Weak OCF overrides strong Net Income. Explicitly downgrade quality if OCF < Net Income.\n"
                 "7. **REALISTIC INTERPRETATION**: Contextualize ratios (e.g. Current Ratio 1.2 is 'adequate', not 'high').\n"
                 "8. **VALUATION LOGIC**: Interpret multiples (High P/E = Growth expectations or Overvaluation?). No raw lists.\n"
                 "9. **RISK HIERARCHY**: 1. Financial, 2. Business Model, 3. Macro. Don't invent risks.\n"
                 "10. **CONCLUSION**: Neutral, non-advisory. No 'Buy/Sell/Hold'. Use 'presents a trade-off'.\n\n"
                 "CRITICAL RULES:\n"
