...
const AR_DESC =
    'صناديق الاستثمار في مصر التي تنشر صافي قيمة أصولها: القيمة والعوائد ورسوم الإدارة والمدير لكل صندوق، مصنّفة حسب الفئة ومحدثة مرتين يومياً من الإفصاحات الرسمية.';
