...
\restrict b1j49A1wpJsagj0HfJN5hP3Geag5NkhcFEebZp4ZRVx4kwE3a5T1rjT4mnpeWOW
...
ALTER TABLE public.analyst_ratings_id_seq OWNER TO postgres;
...
ALTER TABLE public.etfs OWNER TO postgres;
...
ALTER TABLE public.fair_values OWNER TO postgres;
...
ALTER TABLE public.fair_values_id_seq OWNER TO postgres;
...
ALTER TABLE public.financial_ratios_extended OWNER TO postgres;
...
ALTER TABLE public.financial_ratios_extended_id_seq OWNER TO postgres;
...
ALTER TABLE public.financial_statements_id_seq OWNER TO postgres;
...
ALTER TABLE public.index_history OWNER TO postgres;
...
ALTER TABLE public.index_history_id_seq OWNER TO postgres;
...
ALTER TABLE public.insider_trading OWNER TO postgres;
...
ALTER TABLE public.insider_trading_id_seq OWNER TO postgres;
...
ALTER TABLE public.insider_transactions_id_seq OWNER TO postgres;
...
ALTER TABLE public.intraday_ohlc OWNER TO postgres;
...
ALTER TABLE public.ipo_history_id_seq OWNER TO postgres;
...
ALTER TABLE public.major_shareholders OWNER TO postgres;
...
ALTER TABLE public.major_shareholders_id_seq OWNER TO postgres;
...
ALTER TABLE public.market_breadth OWNER TO postgres;
...
ALTER TABLE public.market_news_id_seq OWNER TO postgres;
...
ALTER TABLE public.mutual_funds OWNER TO postgres;
...
ALTER TABLE public.ohlc_data OWNER TO postgres;
...
ALTER TABLE public.ohlc_history OWNER TO postgres;
...
ALTER TABLE public.order_book_snapshot OWNER TO postgres;
...
ALTER TABLE public.portfolio_holdings_id_seq OWNER TO postgres;
...
ALTER TABLE public.sector_classification OWNER TO postgres;
...
ALTER TABLE public.sector_performance OWNER TO postgres;
...
ALTER TABLE public.technical_levels OWNER TO postgres;
...
ALTER TABLE public.technical_levels_id_seq OWNER TO postgres;
...
ALTER TABLE public.trade_history_id_seq OWNER TO postgres;
...
ALTER TABLE public.volume_statistics OWNER TO postgres;
...
ALTER TABLE public.volume_statistics_id_seq OWNER TO postgres;
...
\unrestrict b1j49A1wpJsagj0HfJN5hP3Geag5NkhcFEebZp4ZRVx4kwE3a5T1rjT4mnpeWOW
