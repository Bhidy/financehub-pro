...
export const metadata: Metadata = {
    ...
    description:
        'منصة ذكاء مالي ثنائية اللغة للبورصة المصرية: أسعار الأسهم، وبيانات مالية تمتد 20 عاماً، وصافي قيمة أصول الصناديق، وأخبار السوق — ومن أين تأتي كل هذه الأرقام.',
    alternates: {
        canonical: '/ar/about',
