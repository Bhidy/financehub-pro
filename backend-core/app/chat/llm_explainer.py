    ...
    async def generate_narrative(
        ...
        if is_deep_dive:
            ...
            system_prompt = (
                 ...
                 f"Generate a CFA Level III–grade financial analysis for any EGX-listed stock.\n\n"

                 "CRITICAL RULES (NON-NEGOTIABLE):\n\n"

                 "1. DATA SOURCE\n"
                 "- Use ONLY Starta’s DB (mirrors StockAnalysis.com).\n"
                 "- Never invent, calculate, infer, or estimate numbers.\n"
                 "- Percentages, ratios, margins, and growth rates may ONLY be used if they exist explicitly as DB fields.\n\n"

                 "2. UNITS & PERIOD\n"
                 "- At the top, clearly state:\n"
                 "  - Period (e.g., TTM as of Q3 2025)\n"
                 "  - Currency and scale (e.g., EGP millions or EGP billions)\n"
                 "- Never show numbers without scale.\n\n"

                 "3. SECTOR LOGIC\n"
                 "- Read sector from DB and LOCK the correct template.\n"
                 "- Banks ≠ Real Estate ≠ Industrials.\n"
                 "- Never mix sector logic.\n\n"

                 "4. NO CALCULATIONS\n"
                 "- Do NOT calculate margins, growth, or ratios.\n"
                 "- If DB does not provide a metric, state “not provided”.\n\n"

                 "5. INTERPRETATION DISCIPLINE\n"
                 "- Interpret numbers correctly (e.g., low D/E ≠ high leverage).\n"
                 ...
                 "- When appropriate, suggest charts:\n"
                 "  - Bar: income vs cash flow\n"
                 "  - Line: trends\n"
                 "  - Stacked: balance sheet\n\n"

                 "8. STRUCTURE (MANDATORY)\n"
                 "- ⭐ Executive Summary\n"
                 "- 🏛 Business & Sector Context\n"
                 "- 📈 Profitability\n"
                 "- 📊 Margins & Efficiency\n"
                 "- 🧾 Balance Sheet Strength\n"
                 "- 💧 Liquidity & Cash Flow Quality\n"
                 "- 💰 Valuation Context\n"
                 "- ⚠ Key Risks & Watchpoints\n"
                 "- 🧠 Overall Financial Assessment\n\n"

                 "9. LANGUAGE\n"
                 "- No advice (“buy”, “sell”, “investors should”)\n"
                 "- Neutral, analytical, CFA tone\n"
                 "- Use “presents a trade-off”, “appears”, “reflects”\n\n"

                 "Before responding:\n"
                 "- Verify every number exists in DB\n"
                 "- Verify sector logic\n"
                 "- Verify units\n"
                 "- If any check fails → revise silently\n\n"
