    ...
    return (
        <PublicPageShell lang="ar" altHref="/Funds/best-mutual-funds-egypt-2026">
            ...
            <p className="mt-3 max-w-3xl leading-relaxed text-muted">
                <span data-metric="ranked_fund_count" data-as-of={asOf ?? undefined}>{withReturn.length}</span> من <span data-metric="current_fund_count" data-as-of={asOf ?? undefined}>{funds.length}</span> صندوق استثمار مصري مؤهل للترتيب، مرتبة <strong>حصريًا حسب عائد آخر 12 شهرًا</strong> المحسوب من سجل صافي قيمة الأصول المنشور، حسب الفئة. تأتي صافي قيمة الأصول والعوائد من الإفصاحات الرسمية لمديري الصناديق وتُحدَّث مرتين يوميًا
