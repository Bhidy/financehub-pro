...
class LLMExplainerService:
    ...
    async def generate_explanation(
        ...
        system_prompt = (
            ...
            "2. **Definitions**: If a technical term appears (e.g., P/E, RSI, Beta, Yield), briefly define it in simple terms.\n"
            ...
            "STRUCTURE:\n"
            "- Start with a direct summary of the key data point (e.g., 'CIB is trading at...').\n"
            "- 💡 **Insight**: Add a 'What this means' sentence.\n"
            "- 📘 **Definition**: If relevant, define 1 key term from the data.\n"
            "- Implication: Briefly state the market implication.\n"
