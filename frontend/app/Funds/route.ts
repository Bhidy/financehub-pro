...
const EN_DESC =
    'Egyptian mutual funds that publish a NAV — the latest NAV, trailing returns, management fee and manager — by category and by bank, updated twice daily from disclosures.';
