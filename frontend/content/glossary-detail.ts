...
export const GLOSSARY_DETAIL: Record<string, GlossaryDetailEntry> = {
    ...
    'bull-market': {
        ...
        ar: {
            ...
            mistake: 'اعتبار السوق الصاعد دليلاً على المهارة. فحين يرتفع معظم شيء، لا تقول المحفظة المرتفعة الكثير عن القرارات داخلها، والثقة المبنية في تلك الفترة كثيراً ما تُختبر بقسوة في التالية. والمقياس العملي ليس كم ربحت في سوق صاعد، بل ماذا كنت ستفعل لو تراجع ثلث محفظتك — وهو سؤال لا تجيب عنه إلا فترة هبوط فعلية.',
        },
    },
    'bear-market': {
        en: {
        ...
        ar: {
            ...
            whyItMatters: 'الأسواق الهابطة هي حين تصبح الفجوة بين الخطة وسلوك المستثمر مكلفة، لأن قرار البيع يُتخذ تحت أقوى ضغط ممكن لاتخاذه. كما أن الأسواق الهابطة هي التي تصنع الفارق بين عائد الصندوق وعائد مستثمريه: فالصندوق يسجّل الفترة كاملة، أما المستثمر الذي خرج في القاع فيسجّل الجزء الهابط منها وحده.',
    ...
    'volatility': {
        ...
        ar: {
            example: 'قد ينهي سهمان عاماً بارتفاع عشرة في المئة بينما تحرك أحدهما في نطاق ضيق طوال العام وانخفض الآخر ثلاثين في المئة في منتصفه قبل أن يتعافى. والثاني أشد تقلباً بكثير رغم تطابق النتيجة. ولهذا يمكن لصندوقين أن يعلنا العائد السنوي نفسه بينما كانت تجربة الاحتفاظ بهما مختلفة تماماً.',
    ...
    'portfolio': {
        ...
        ar: {
            ...
            mistake: 'الحكم على كل حيازة بأدائها وحدها. فالسؤال الصحيح ما الذي تفعله الحيازة للمحفظة — وما ينخفض حين يرتفع كل شيء آخر قد يكون يؤدي وظيفته بالضبط. والسؤال الأنفع عند المراجعة ليس أي الحيازات كان الأسوأ هذا العام، بل هل ما زال لكل حيازة سبب يبررها ضمن الكل.',
        },
    },
    'broker': {
        en: {
        ...
        ar: {
            example: 'تضع أمراً لدى شركة سمسرة مرخّصة، فتوجّهه إلى البورصة وترتّب التسوية بعد التنفيذ. وتُقيَّد الأسهم باسمك مركزياً لا باسم السمسار. وتظهر العمولة والرسوم الأخرى في إشعار التنفيذ الذي يصلك بعد كل صفقة، وهو المستند الذي يُتحقق منه لا التطبيق.',
    ...
    'order-book': {
        ...
        ar: {
            ...
            whyItMatters: 'من سجل الأوامر يأتي السعر فعلاً: فهو السجل الحي لما سيدفعه المشترون وما سيقبله البائعون، وعمقه يخبرك بحجم ما يستطيع السوق استيعابه. وعمق السجل هو أيضاً ما يفرّق بين سعر معلن وسعر قابل للتنفيذ بحجمك أنت.',
    ...
    'market-order': {
        ...
        ar: {
            ...
            mistake: 'استخدامه في سوق ضعيف السيولة أو سريع الحركة. فمع قلة العمق في السجل قد يُنفَّذ الأمر السوقي بعيداً عن السعر الذي رأيته، والتنفيذ غير قابل للتراجع بعد وقوعه. والقاعدة العملية البسيطة: كلما قلّ عمق السجل، زادت قيمة الأمر المحدد على حساب سرعة الأمر السوقي.',
        },
    },
    'circuit-breaker': {
        en: {
        ...
        ar: {
            example: 'سهم يتحرك بحدة على شائعة غير مؤكدة قد يُوقَف. فيتوقف التداول وتطلب البورصة إيضاحاً من الشركة، وتمنح الوقفة كل المشاركين المعلومات نفسها قبل استئناف التعامل. وقد يُستأنف التداول في الجلسة نفسها أو في التالية تبعاً لطبيعة الإفصاح المطلوب.',
    ...
    'unified-investor-code': {
        ...
        ar: {
            ...
            whyItMatters: 'هو ما يجعل الملكية قابلة للنقل والتحقق: إذ يمكنك الانتقال بين السماسرة دون أن تنتقل أسهمك، لأن السجل يعرّف المالك لا السمسار. وهو أيضاً ما يتيح للجهات الرقابية رؤية مركز المستثمر مجمّعاً بدل رؤيته مبعثراً لدى وسطاء متعددين.',
    ...
    'coupon': {
        ...
        ar: {
            ...
            whyItMatters: 'معرفة المعنى المقصود تمنع لبساً حقيقياً: فكوبون السند تعاقدي ومجدول، أما التوزيع فيُعلن بتقدير الشركة ويمكن خفضه أو تخطيه. ويهم التمييز عملياً عند قراءة إعلان: فإعلان كوبون سند تأكيد لالتزام قائم، وإعلان توزيع سهم قرار جديد لمجلس الإدارة.',
            mistake: 'التعامل مع الاثنين كالتزامين متكافئين. فتخلّف السند عن كوبون تعثّر؛ أما تعليق التوزيع فقرار يحق للشركة اتخاذه. كذلك يختلف مصدر المال: فكوبون السند يُدفع من التزام تعاقدي على المُصدر، أما توزيع السهم فيُدفع من أرباح محققة أو احتياطيات متاحة للتوزيع.',
        },
    },
    'fra': {
        en: {
        ...
        ar: {
            example: 'لا يجوز طرح صندوق استثمار على الجمهور قبل إيداع نشرة اكتتابه لدى الهيئة واعتمادها، ثم يقدّم الصندوق تقاريره إليها بصفة مستمرة. وينطبق الأمر نفسه على شركات السمسرة ومديري الأصول: فالترخيص شرط لمزاولة النشاط لا ميزة تسويقية.',
    ...
    'stamp-duty': {
        ...
        ar: {
            example: 'تُطبَّق الضريبة على قيمة الصفقة ويحصّلها السمسار إلى جانب العمولة، فتظهر في إشعار التنفيذ لا تُدفع على حدة. وتظهر في إشعار التنفيذ إلى جانب العمولة، فيكون صافي ما تدفعه أو تقبضه مختلفاً عن قيمة الصفقة المجردة.',
    ...
    'treasury-bills': {
        ...
        ar: {
            ...
            whyItMatters: 'الأذون هي الأداة قصيرة الأجل التي تُبنى منها صناديق أسواق النقد إلى حد بعيد، ولذا فعوائدها المحرك الرئيسي لما تحققه تلك الفئة كلها. ولهذا فإن متابعة عوائد الأذون تخبرك عن اتجاه صناديق أسواق النقد أكثر مما يخبرك به أداء أي صندوق منها بمفرده.',
    ...
    'foreign-ownership-limit': {
        ...
        ar: {
            example: 'قد تضع شركة في قطاع منظّم حداً لنسبة أسهمها التي يجوز لغير المصريين امتلاكها. ومتى بُلغ الحد تُقيَّد مشتريات الأجانب الإضافية بصرف النظر عن الطلب. وتُفصح الشركات الخاضعة لهذه القيود عنها في نشراتها وبياناتها، فهي معلومة معلنة لا مخفية.',
