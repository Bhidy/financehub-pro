/**
 * ============================================================================
 * ULTRA-PREMIUM MOBILE FORGOT PASSWORD - WORLD-CLASS FINTECH DESIGN
 * ============================================================================
 * 
...
function ForgotPasswordContent() {
    ...
    // ========================================================================
    // DESKTOP LAYOUT - Matches frontend/app/forgot-password/page.tsx
    // ========================================================================
    if (isDesktop) {
        return (
            <div className="min-h-screen w-full flex overflow-hidden bg-white dark:bg-[#0A0F1C]">
                ...
                {/* Right Panel - Form (Reused Desktop Logic) */}
                    ...
                    <div className="flex gap-3 justify-center">
                        {otp.map((digit, idx) => (
                            <input
                                ...
                                className="w-16 h-16 text-center text-2xl font-bold rounded-xl bg-slate-50 dark:bg-white/5 border-2 border-slate-200 dark:border-white/10 focus:border-[#14B8A6] focus:ring-4 focus:ring-[#14B8A6]/20 outline-none transition-all text-slate-900 dark:text-white caret-[#14B8A6]"
                                inputMode="numeric"
                                autoFocus={idx === 0}
                            />
                        ))}
