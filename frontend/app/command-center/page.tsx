                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 text-sm">Made with ❤️ by Bhidy • <span className="font-mono bg-blue-50 text-blue-600 px-1 py-0.5 rounded text-xs font-bold">v1.0.7</span></p>
                            </div>
                        </div>
