...
const AR_DESC =
    'صناديق الاستثمار في مصر التي تنشر صافي قيمة أصولها: صافي قيمة الأصول والعوائد ورسوم الإدارة ومدير كل صندوق، مصنّفة حسب الفئة ومحدثة مرتين يومياً من الإفصاحات الرسمية.';
