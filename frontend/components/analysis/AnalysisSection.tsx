    ...
    return (
        <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Visual */}
                <div className="lg:col-span-1 relative overflow-hidden bg-white dark:bg-[#1A1F2E] rounded-3xl p-6 shadow-xl border border-slate-100 dark:border-white/5">
                ...
                {/* Narrative */}
                <div className="lg:col-span-2 relative overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800 dark:from-[#0F1629] dark:to-[#0B1120] rounded-3xl p-8 shadow-2xl text-white">
                    <div className="absolute top-0 right-0 w-96 h-96 bg-indigo-500/10 blur-[100px] rounded-full pointer-events-none" />

                    <div className="relative z-10">
                        <h2 className="text-3xl font-black mb-4">Executive Summary</h2>
                            ...
                            {[
                                ...
                                <div key={idx} className="bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur-sm">
                                    ...
                                    <div className="flex items-end gap-1">
                                        ...
                                        <span className="text-sm text-slate-500 mb-1">/6</span>
                                    </div>
                                </div>
                            ))}
                        </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                ...
                {/* VALUATION */}
                <div className="bg-white dark:bg-[#1A1F2E] rounded-3xl p-8 shadow-xl border border-slate-100 dark:border-white/5">
