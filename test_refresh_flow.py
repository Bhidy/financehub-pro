...
PASSWORD = "***REMOVED-CREDENTIAL***" # Or whatever the admin password is. Wait, the seeding script uses a bcrypt hash for admin@finhub.pro. Let's create a test user instead via the signup endpoint.
